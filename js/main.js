                ...
                if ($elementCarousel.elExists()) {
                    ...
                    $elementCarousel.each(function (index, element) {
                        ...
                        var $spaceBetween = $options.spaceBetween ? parseInt($options.spaceBetween) : 0,
                            ...
                            $prevArrow = $arrows === true ? ($options.prevArrow ? '<span class="' + $options.prevArrow.buttonClass + '"><i class="' + $options.prevArrow.iconClass + '"></i></span>' : '<button class="slick-prev slick-arrow">previous</button>') : '',
                            $nextArrow = $arrows === true ? ($options.nextArrow ? '<span class="' + $options.nextArrow.buttonClass + '"><i class="' + $options.nextArrow.iconClass + '"></i></span>' : '<button class="slick-next slick-arrow">next</button>') : '',
